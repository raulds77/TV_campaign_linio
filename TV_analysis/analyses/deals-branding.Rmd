...
spts0 <- spot[which(as.POSIXlt(spot$tmstmp)>=beg0 & as.POSIXlt(spot$tmstmp)<=(end0)),]

spts1$type <- "Cable 30\" Branding"
spts2$type <- "Cable 10\" Deals"
spts0$type <- "Sky 30\" Branding"

spts <- rbind(spts1,spts2, spts0)
